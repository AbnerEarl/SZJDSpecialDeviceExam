package com.example.frank.jinding.UI.AuthorActivity;
...
public class AuthorizedPersonsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_authorized_persons);
        ...
        lv_message.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                if (menuname_item.contains("审批检验报告")){
    ...
    private void initpermission(){
        permissMyAdapter=new PermissMyAdapter(AuthorizedPersonsActivity.this);
        getPermissions();
        ...
        lv_permissions.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                Permission.excutePermissions(map.get("ItemText").toString(),AuthorizedPersonsActivity.this);

            }
        });


        new AlertDialog.Builder(AuthorizedPersonsActivity.this)
                .setTitle("额外的权限：")
                .setView(layout)
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ApiService.GetString(AuthorizedPersonsActivity.this, "extraPermissions", paremetes, new RxStringCallback() {
                        ...
                        public void onNext(Object tag, String response) {
                            ...
                            if (response.trim().split(":")[0].equals("true")) {
                                ...
                                Toast.makeText(AuthorizedPersonsActivity.this,"没有额外权限",Toast.LENGTH_SHORT).show();
                            }
                        }

                        @Override
                        public void onError(Object tag, Throwable e) {
                            Toast.makeText(AuthorizedPersonsActivity.this, "获取失败" + e, Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
       ...
       // getMenuInflater().inflate(R.menu.authorized_persons, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_post4) {
           ...
           // startActivity(intent);
            ...
            finish();
        }else if (id==R.id.extra_permission_authorized){
            initpermission();
        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ApiService.GetString(AuthorizedPersonsActivity.this, "getMessageInfo", paremetes, new RxStringCallback() {
                        boolean flag = false;
                            ...
                            if (!response.trim().equals("获取失败！")&&response.trim().length()>3) {
                                ...
                                for (int i=0;i+1<data.length;i++){
                                    ...
                                    if (dd[2]!=null&&!dd[2].trim().equals("")&&Integer.parseInt(dd[2].trim())>0){
                                        ...
                                        if (MenuMessage.authorizer.contains(dd[1].trim())){
