...
import com.example.frank.jinding.Upload.net.ftp.FTPClientConfig;
...
public class VMSFTPEntryParser extends ConfigurableFTPFileEntryParserImpl {
  ...
  @Deprecated public FTPFile[] parseFileList(java.io.InputStream listStream) throws IOException {
    com.example.frank.jinding.Upload.net.ftp.FTPListParseEngine engine =
        new com.example.frank.jinding.Upload.net.ftp.FTPListParseEngine(this);
