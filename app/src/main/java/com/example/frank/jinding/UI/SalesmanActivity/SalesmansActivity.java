...
public class SalesmansActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salesmans);
        ...
        lv_message.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                Intent intent = new Intent(CheckersActivityNew.this, OrderDetails.class);
                intent.putExtra("update", false);

                startActivity(intent);*/
                Toast.makeText(SalesmansActivity.this, "快捷事件处理方式正在研发中……" , Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initpermission(){
        permissMyAdapter=new PermissMyAdapter(SalesmansActivity.this);
        getPermissions();
        ...
        lv_permissions.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                Permission.excutePermissions(map.get("ItemText").toString(),SalesmansActivity.this);

            }
        });


        new AlertDialog.Builder(SalesmansActivity.this)
                .setTitle("额外的权限：")
                .setView(layout)
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ApiService.GetString(SalesmansActivity.this, "extraPermissions", paremetes, new RxStringCallback() {
                        ...
                        public void onNext(Object tag, String response) {
                            ...
                            if (response.trim().split(":")[0].equals("true")) {
                                ...
                                Toast.makeText(SalesmansActivity.this,"没有额外权限",Toast.LENGTH_SHORT).show();
                            }
                        }

                        @Override
                        public void onError(Object tag, Throwable e) {
                            Toast.makeText(SalesmansActivity.this, "获取失败" + e, Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
      ...
      //  getMenuInflater().inflate(R.menu.salesmans, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_addorder3) {
            Intent intent=new Intent(SalesmansActivity.this,AddOrder.class);
            ...
            Intent intent=new Intent(SalesmansActivity.this,SalesmanFinance.class);
            startActivity(intent);
        }
        else if (id == R.id.nav_personinfo3) {
            Intent intent=new Intent(SalesmansActivity.this,PersonInformation.class);
            //intent.putExtra("userid",userid);
            startActivity(intent);
        } else if (id == R.id.nav_exit3) {
            finish();
        }else if (id==R.id.extra_permission_salesman){
            initpermission();
        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    ApiService.GetString(SalesmansActivity.this, "getMessageInfo", paremetes, new RxStringCallback() {
                        boolean flag = false;
                            ...
                            if (!response.trim().equals("获取失败！")&&response.trim().length()>3) {
                                ...
                                for (int i=0;i+1<data.length;i++){
                                    ...
                                    if (dd[2]!=null&&!dd[2].trim().equals("")&&Integer.parseInt(dd[2].trim())>0){
                                        ...
                                        if (MenuMessage.salesmans.contains(dd[1].trim())){
