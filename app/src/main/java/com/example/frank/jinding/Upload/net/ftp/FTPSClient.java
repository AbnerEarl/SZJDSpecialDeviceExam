...
import com.example.frank.jinding.Upload.net.util.Base64;
import com.example.frank.jinding.Upload.net.util.SSLContextUtils;
import com.example.frank.jinding.Upload.net.util.SSLSocketUtils;
import com.example.frank.jinding.Upload.net.util.TrustManagerUtils;
